...
```bash
dotnet add package ISOCodex.Currency.Exchange.Abstractions --version 1.1.1
```
...
The initial converter supports direct rates only. Inverse, triangulated, cached, and live-provider behaviours are deferred future package work, not part of the `1.1.1` stable scope.
